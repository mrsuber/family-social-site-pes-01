...
{
  name:'Introduction',
  detail:"Whether it be IMDB’s top 250 movies or the FBI’s most wanted, lists are everywhere on the web and you are going to need one eventually in your webpages.",
  detail1:"Luckily, with HTML there are a couple of different types of lists at your disposal.",
  detail2:"",
  detail3:"",
  detail4:"",
  detail5:"",
...
},
{
  name:'Lesson Overview',
  detail:"This section contains a general overview of topics that you will learn in this lesson.",
  detail1:"1.)How to create an unordered list",
  detail2:"2.)How to create an ordered list",
  detail3:"",
  detail4:"",
  detail5:"",
  detail6:"",
...
},
{
  ...
  detail:"If you want to have a list of items where the order doesn’t matter, like a shopping list of items that can be bought in any order, then you can use an unordered list.",
  detail1:"Unordered lists are created using the <ul> element, and each item within the list is created using the list item element <li>.",
  detail2:"Each list item in an unordered list begins with a bullet point:",
  detail3:"",
  detail4:"",
  detail5:"",
  detail6:"",
  ancorName:"Unordered Lists",
  popup1Name:"Unordered Lists",
  popup1:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1653641292/msbGeanologyProfilePics/ul_list_kfmyjz.png",
  popup2Name:"",
  popup2:"",
},
{
  name:'Ordered Lists',
  detail:"If you instead want to create a list of items where the order does matter, like step-by-step instructions for a recipe, or your top 10 favorite TV shows, then you can use an ordered list.",
  detail1:"Ordered lists are created using the <ol> element. Each individual item in them is again created using the list item element <li>. However, each list item in an ordered list begins with a number instead:",
  detail2:"",
  detail3:"",
  detail4:"",
  detail5:"",
  detail6:"",
  ancorName:"Ordered Lists",
  popup1Name:"Ordered Lists",
  popup1:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1653641861/msbGeanologyProfilePics/ol_list_sxdrtw.png",
  popup2Name:"",
  popup2:"",
},
{
  name:'Assignment',
  detail:"To get some practice using lists, create a new HTML document and create the following lists:",
  detail1:"1.)An unordered shopping list of your favorite foods",
  detail2:"2.)An ordered list of todo’s you need to get done today",
  detail3:"3.)An unordered list of places you’d like to visit someday",
  detail4:"4.)An ordered list of your all time top 5 favorite video games or movies",
  detail5:"",
  detail6:"",
  ancorName:"Assignment",
  popup1Name:"",
...
additionalRead:[
{
  title:"MDN documentation on the unordered list element",
  url:"https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ul"
},
{
  title:"MDN documentation on the ordered list element",
  url:"https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ol"
},
{
  title:"Shay Howe’s HTML lists tutorial",
  url:"https://learn.shayhowe.com/html-css/creating-lists/"
},
],
KnowledgeCheck:[
  {
    check:"What HTML tag is used to create an unordered list?"
  },
  {
    check:"What HTML tag is used to create an ordered list?"
  },
  {
    check:"What HTML tag is used to create list items within both unordered and ordered lists?"
  },
],
source:[
{
...
{
name:'Introduction',
detail:"Links are one of the key features of HTML. They allow us to link to other HTML pages on the web. In fact, this is why it’s called the web.",
detail1:"In this lesson, we will learn how to create links and add some visual flair to our websites by embedding images.",
detail2:"",
detail3:"",
detail4:"",
detail5:"",
...
name:'Lesson Overview',
detail:"This section contains a general overview of topics that you will learn in this lesson.",
detail1:"1.)How to create links to pages on other websites on the internet",
detail2:"2.)How to create links to other pages on your own websites",
detail3:"3.)The difference between absolute and relative links",
detail4:"4.)How to display an image on webpage using HTML",
detail5:"",
detail6:"",
ancorName:"Lesson Overview",
popup1Name:"",
...
{
name:'Preparation',
detail:"To get some practice using links and images throughout this lesson we need an HTML project to work with.",
detail1:"1. Create a new directory named ```msb-links-and-images```.",
detail2:"2. Within that directory, create a new file named index.html.",
detail3:"3. Fill in the usual HTML boilerplate.",
detail4:"4. Finally, add the following h1 to the body:",
detail5:" <h1>Homepage</h1>",
detail6:"",
ancorName:"Preparation",
popup1Name:"",
popup1:"",
popup2Name:"",
popup2:"",
...
detail:"To create a link in HTML, we use the anchor element. An anchor element is defined by wrapping the text or another HTML element we want to be a link with an <a> tag.",
detail1:"Add the following to the body of the index.html page we created and open it in the browser:",
detail2:"<a>click me</a>",
detail3:"You may have noticed that clicking this link doesn’t do anything. This is because an anchor tag on its own won’t know where we want to link to. We have to tell it a destination to go to. We do this by using an HTML attribute.",
...
detail5:"Add the following href attribute to the anchor element we created previously and try clicking it again, don’t forget to refresh the browser so the new changes can be applied.",
detail6:'<a href="https://www.theodinproject.com/about">click me</a>',
detail7:'By default, any text wrapped with an anchor tag without a href attribute will look like plain text. If the href attribute is present, the browser will give the text a blue color and underline it to signify it is a link.',
detail8:'It’s worth noting you can use anchor tags to link to any kind of resource on the internet, not just other HTML documents. You can link to videos, pdf files, images, and so on, but for the most part, you will be linking to other HTML documents.',
ancorName:"",
popup1Name:"Anchor Elements",
popup1:"",
popup2Name:"",
popup2:"",
},
...
detail:"Generally, there are two kinds of links we will create:",
detail1:"1. Links to pages on other websites on the internet",
detail2:"2. Links to pages located on our own websites",
detail3:"",
detail4:"",
detail5:"",
detail6:"",
ancorName:"Absolute and Relative Links",
popup1Name:"",
popup1:"",
popup2Name:"",
popup2:"",
...
{
name:'Absolute Links',
detail:"Links to pages on other websites on the internet are called absolute links. A typical absolute link will be made up of the following parts: protocol://domain/path. An absolute link will always contain the protocol and domain of the destination.",
detail1:"We’ve already seen an absolute link in action. The link we created to The Odin Project’s About page earlier was an absolute link as it contains the protocol and domain.",
detail2:"https://www.project.com/about",
detail3:"",
detail4:"",
detail5:"",
detail6:"",
ancorName:"Absolute Links",
popup1Name:"",
popup1:"",
popup2Name:"",
popup2:"",
...
{
name:'Relative Links',
detail:"Links to other pages within our own website are called relative links. Relative links do not include the domain name, since it is another page on the same site, it assumes the domain name will be the same as the page we created the link on.",
detail1:"Relative links only include the file path to the other page, relative to the page you are creating the link on. This is quite abstract, let’s see this in action using an example.",
detail2:"Within ```the msb-links-and-images``` directory, create another HTML file named about.html and paste the following code into it:",
detail3:"Back in the index page, add the following anchor element to create a link to the about page:",
detail4:"Open the index file in a browser and click on the about link to make sure it is all wired together correctly. Clicking the link should go to the about page we just created.",
detail5:"This works because the index and about page are in the same directory. That means we can simply use its name (about.html) as the link’s href value.",
detail6:"But we will usually want to organize our website directories a little better. Normally we would only have the index.html at the root directory and all other HTML files in their own directory.",
detail7:"Create a directory named pages within the odin-links-and-images directory and move the about.html file into this new directory.",
detail8:"Refresh the index page in the browser and then click on the about link. It will now be broken. This is because the location of the about page file has changed.",
detail9:"To fix this, we just need to update the about link href value to include the pages/ directory since that is the new location of the about file relative to the index file.",
detail10:"Refresh the index page in the browser and try clicking the about link again, it should now be back in working order.",
detail11:"In many cases, this will work just fine; however, you can still run into unexpected issues with this approach. Prepending ./ before the link will in most cases prevent such issues. By adding ./ you are specifying to your code that it should start looking for the file/directory relative to the current directory.",
ancorName:"Relative Links",
popup1Name:"relative link",
popup1:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1653643895/msbGeanologyProfilePics/relative_link_td1h2t.png",
popup2Name:"absolute link",
popup2:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1653644249/msbGeanologyProfilePics/absolutlink_vmo5o6.png",
},
{
name:'A Metaphor',
detail:"Absolute and relative links are a tricky concept to build a good mental model of, a metaphor may help:",
detail1:"Think of your domain name (town.com) as a town, the directory in which your website is located (/museum) as a museum, and each page on your website as a room in the museum (/museum/movie_room.html and /museum/shops/coffee_shop.html). Relative links like ./shops/coffee_shop.html are directions from the current room (the museum movie room /museum/movie_room.html) to another room (the museum shop). Absolute links, on the other hand, are full directions including the protocol (https), domain name (town.com) and the path from that domain name (/museum/shops/coffee_shop.html): https://town.com/museum/shops/coffee_shop.html.",
detail2:"",
detail3:"",
detail4:"",
detail5:"",
detail6:"",
ancorName:"A Metaphor",
popup1Name:"",
popup1:"",
popup2Name:"",
popup2:"",
...
{
name:'Images',
detail:"Websites would be fairly boring if they could only display text. Luckily HTML provides a wide variety of elements for displaying all sorts of different media. The most widely used of these is the image element.",
detail1:"To display an image in HTML we use the <img> element. Unlike the other elements we have encountered so far, the <img> element is empty. Which means it doesn’t have a closing tag.",
...
detail3:"For example, using an absolute path we can display an image located on The Odin Project site:",
detail4:"To use images that we have on our own websites, we can use a relative path.",
detail5:"1. Create a new directory named images within the odin-links-and-images project.",
detail6:"2. Next, download this image and move it into the images directory we just created.(check the link to download in the source)",
detail7:"3. Rename the image to dog.jpg.",
detail8:"Finally add the image to the index.html file:",
detail9:"Save the index.html file and open it in a browser to view Charles in all his glory.",
ancorName:"Images",
popup1Name:"image display",
popup1:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1653644641/msbGeanologyProfilePics/images_aqfnin.png",
popup2Name:"",
popup2:"",
},
{
name:'Parent Directories',
detail:"What if we want to use the dog image in the about page? We would first have to go up one level out of the pages directory into its parent directory so we could then access the images directory.",
detail1:"To go to the parent directory we need to use two dots in the relative filepath like this: ../. Let’s see this in action, within the body of the about.html file, add the following image below the heading we added earlier:",
detail2:'<img src="../images/dog.jpg">',
detail3:"To break this down:",
detail4:"1. First, we are going to the parent directory of the pages directory which is odin-links-and-images.",
detail5:"2. Then, from the parent directory, we can go into the images directory.",
detail6:"3. Finally, we can access the dog.jpg file.",
detail7:"Using the metaphor we used earlier, using ../ in a filepath is kind of like stepping out from the room you are currently in to the main hallway so you can go to another room.",
ancorName:"Parent Directories",
popup1Name:"",
popup1:"",
popup2Name:"",
popup2:"",
...
{
name:'Alt attribute',
detail:"Besides the src attribute, every image element should also have an alt (alternative text) attribute.",
detail1:"The alt attribute is used to describe an image. It will be used in place of the image if it cannot be loaded. It is also used with screen readers to describe what the image is to visually impaired users.",
detail2:"This is how the The Odin Project logo example we used earlier looks with an alt attribute included:",
detail3:"As a bit of practice, add an alt attribute to the dog image we added to the odin-links-and-images project.",
detail4:"",
detail5:"",
detail6:"",
ancorName:"Alt attribute",
popup1Name:"alt atribute",
popup1:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1653646504/msbGeanologyProfilePics/image_atribute_ujkhst.png",
popup2Name:"",
popup2:"",
},
...
{
name:'Assignment',
detail:"Watch Kevin Powell’s HTML Links Video.",
detail1:"Watch Kevin Powell’s HTML Images Video.",
detail2:"Watch Kevin Powell’s File Structure Video.",
detail3:"Read about the four main image formats that can be used on the web.",
detail4:" ",
detail5:"",
detail6:"",
ancorName:"Assignment",
...
additionalRead:[
{
title:"Watch Kevin Powell’s HTML Links Video.",
url:"https://www.youtube.com/watch?v=tsEQgGjSmkM&list=PL4-IK0AVhVjM0xE0K2uZRvsM7LkIhsPT-&index=5"
},
{
title:"Watch Kevin Powell’s HTML Images Video",
url:"https://www.youtube.com/watch?v=0xoztJCHpbQ&list=PL4-IK0AVhVjM0xE0K2uZRvsM7LkIhsPT-&index=6"
},
{
title:"Watch Kevin Powell’s File Structure Video.",
url:"https://www.youtube.com/watch?v=ta3Oxx7Yqbo&list=PL4-IK0AVhVjM0xE0K2uZRvsM7LkIhsPT-&index=7"
},
{
title:"Read about the four main image formats that can be used on the web.",
url:"https://www.internetingishard.com/html-and-css/links-and-images/#image-formats"
},
{
title:"Interneting is hard’s treatment on HTML links and images",
url:"https://www.internetingishard.com/html-and-css/links-and-images/"
},
{
title:"What happened the day Google decided links including (/) were malware",
...
{
name:"download image ",
link:"https://unsplash.com/photos/Mv9hjnEUHR4/download?force=true&w=640"
},
],
people:[]
},
...
detail6:"",
ancorName:"Assignment",
popup1Name:"This article, How to Write a Git Commit Message, covers all the main bases on how to write good commit messages. The whole article is great and informative but the meat of the article is “The seven rules of a great commit message.”",
popup1:"https://res.cloudinary.com/msb-geneasocial/image/upload/v1654971860/msbGeanologyProfilePics/camsole/1654971691683_wxmrly.png",
popup2Name:"",
popup2:"",
},
{
name:'Tips and Things to Remember:',
detail:"Using VSCode as your text editor (you should have set this up in the Git Basics section) will allow you to easily make multi-line commit messages, easily see the character length of each line, and will allow you to use VSCode spell check extensions to make sure your spelling is correct",
detail1:"Use an active voice: “Fix card generator”",
detail2:"Avoid using vague commit messages such as “saved” or “updated”",
detail3:"Commit early and often!",
detail4:"",
detail5:"",
detail6:"",
ancorName:"Tips and Things to Remember:",
popup1Name:"",
popup1:"",
popup2Name:"",
popup2:"",
...
{
name:'Introduction',
detail:"In this project, you’ll be creating a pretty neat toy for your portfolio to flex your DOM manipulation skills. You’re going to build a browser version of something between a sketchpad and an Etch-A-Sketch.",
detail1:"This project should not be easy for you. You’ll probably have to Google frequently to get the right JavaScript methods and CSS to use – in fact, that’s the point! You can build this using the tools that you have already learned, and there are plenty of resources on the net for learning stuff that we haven’t covered yet if you decide you need it. We’ll walk you through the basic steps, but it will be up to you to actually implement them.",
detail2:"If you get totally stuck, drop by the chatroom. Someone will be there to point you in the right direction.",
detail3:"",
detail4:"",
detail5:"",
detail6:"",
...
{
name:'Assignment',
detail:"Don’t forget to commit early & often!",
detail1:"1). Follow the instructions atop Recipes project to set up a Git repository for this project.",
detail2:"2.)Create a webpage with a 16x16 grid of square divs.",
detail3:"2a.)Create the divs using JavaScript. Don’t try making them by hand with copy and pasting in your HTML file!",
detail4:"2b.)It’s best to put your grid squares inside another “container” div (which can go directly in your HTML).",
detail5:"2c.)There are several different ways to make the divs appear as a grid (versus just one on each line). Feel free to use any or play with each of them:==>float/clear,==>inline-block,==>flexbox, ==>CSS Grid",
detail6:"2d.)Be careful with borders and margins, as they can adjust the size of the squares!",
detail7:"2e.)“OMG, why isn’t my grid being created???” ==>Did you link your CSS stylesheet? ==>Open your browser’s developer tools.==>Check if there are any errors in the JavaScript console.==>Check your “elements” pane to see if the elements have actually shown up but are somehow hidden.==>Go willy-nilly and add console.log statements in your JavaScript to see if it’s actually being loaded.",
detail8:"3.) Set up a “hover” effect so that the grid divs change color when your mouse passes over them, leaving a (pixelated) trail through your grid like a pen would.",
detail9:"3a.) Hint: “Hovering” is what happens when your mouse enters a div and ends when your mouse leaves it. You can set up event listeners for either of those events as a starting point.",
detail10:"3b.) There are multiple ways to change the color of the divs, including:==>adding a new class to the div. ==>changing the div’s background color using JavaScript.",
detail11:"4.)Add a button to the top of the screen that will send the user a popup asking for the number of squares per side for the new grid. Once entered, the existing grid should be removed and a new grid should be generated in the same total space as before (e.g. 960px wide) so that you’ve got a new sketch pad. Tip: Set the limit for the user input to a maximum of 100. A larger number of squares results in more computer resources being used, potentially causing delays, freezing, or crashing that we want to prevent.",
detail12:"4a.)Research button tags in HTML and how you can make a JavaScript function run when one is clicked.",
detail13:"4b.)Also check out prompts.",
detail14:"4c.)You should be able to enter 64 and have a brand new 64x64 grid pop up without changing the total amount of pixels used.",
detail15:"5.) (Optional): Instead of just changing the color of a square from black to white (for example), have each pass through with the mouse change it to a completely random RGB value. Then try having each pass just add another 10% of black to it so that only after 10 passes is the square completely black.",
detail16:"6.) Push your project to GitHub!",
ancorName:"Assignment",
popup1Name:"",
popup1:"",
popup2Name:"",
