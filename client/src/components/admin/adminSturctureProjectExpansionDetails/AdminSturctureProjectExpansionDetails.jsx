...
import {AdminSturcturalProjectExpansionPopUpDetail,AdminResume} from '../../../components'
...
const AdminSturctureProjectExpansionDetails = ({courseName,strutureData,setOnStructuralDetail,logo,setShowCore}) => {
  ...
  },[courseName,filteredStructuralData,strutureData,lenght])
  ...
  return (
...

    {
      onView===true
      /*&& <AdminResume/>*/
      && <AdminSturcturalProjectExpansionPopUpDetail setOnView={setOnView} onView={onView} data={people} position={position} setOnStructuralDetail={setOnStructuralDetail}/>
    ...
    <section>
      ...
      <div className="admin__graph-card admin__Irishhis-container">
          <h3 className="admin__section-head">Structure of PE.(move around with mouse to find tree)</h3>
          ...
          {/*company name*/}
              <li className="li"><nav className="AdminStructure__a-first" >
                        ...
                        <div className="AdminStructure__company-logo">
                          <img src={logo} alt="imgchild"/>
                        </div>

                        <div className="AdminStructure__company-mainItem">
                          <h3>Name: <span>{courseName}</span></h3>
...
export default AdminSturctureProjectExpansionDetails
