...
import {AdminSturcturalCoursePopUpDetail,AdminResume, AdminSturcturalPeoplePopUpDetail} from '../../../components'
...
const ProjectExpansionMangementPopup = ({generalSimpledata,setDepPopup,handleManagementClose}) => {
  ...
  return (
    ...
    <div className='admin_stucture_statistics'>
      ...
      <div className='admin_stucture_statistics_container'>
        <p className='admin_stucture_statistics_para' >Sick leaves No: <span className='admin_stucture_statistics_span'>02</span></p>
      </div>
      <div className='admin_stucture_statistics_container'>
        <p className='admin_stucture_statistics_para' >Loans No: <span className='admin_stucture_statistics_span'>02</span></p>
      </div>
      <div className='admin_stucture_statistics_container'>
        <p className='admin_stucture_statistics_para'>Company Hardware: <span className='admin_stucture_statistics_span'>02</span></p>
      </div>
